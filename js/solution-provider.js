...
if(lang == "en"){
	...
	var f1 = {'title':'魔幻時尚前扣','titleEn':'Strapless Convertible','desc':'Fashion style that would do various coordination ','img': 'a_f1.jpg','link': '/products/魔幻時尚前扣'};		var sub5 = 'Push-up';
	var f2 = {'title':'心機美背內衣','titleEn':'Front-click RacerBack','desc':'Fashion style that would do various coordination ','img': 'a_f2.jpg','link': '/products/心機美背透視'};		var sub6 = 'Unpretentious';
	...
	var f5 = {'title':'V 溝影開襟內衣','titleEn':'Deep Plunge Bra','desc':'','img': 'a_f5.jpg','link': '/products/nude-fashion-optimal-v-plunge-bra'};
	var f6 = {'title':'絕美雕花舒服蕾','titleEn':'Lace Leisuree','desc':'','img': 'a_f6.jpg','link': '/products/絕美雕花舒服蕾'};

	var r1 = {'title':'浪漫四蕾絲','titleEn':'Lace Push-up','desc':'Romantic style that releases the feminine charm.','img': 'a_r1.jpg','link': '/products/浪漫四蕾絲'};		var sub10 = 'Ultra Support';
	var r2 = {'title':'純真雪紡貝蕾','titleEn':'Chiffon Balconette','desc':'','img': 'a_r2.jpg','link': '/products/純真雪紡貝蕾'};		var sub11 = 'Molding';
